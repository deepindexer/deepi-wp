...
<p><?php _e('This plugin requires API keys from <a href="http://www.deepi.ir:8000">Deepi</a>.','deepi'); ?></p>
...
<p><?php _e('If you do not have a Deepi account yet, you can create one for free at <a href="http://www.deepi.ir:8000">Deepi</a>.
Once you have created your account, and you have signed in,','deepi'); ?></p>
<ol>
<li><?php _e('Go to the <a href="http://www.deepi.ir:8000/dashboard/setting/">setting page</a>.','deepi'); ?></li>
...
<li><p><?php _e("API Key",'deepi'); ?></p>
<p><?php _e("<strong>Note</strong>: Copy/pasting these keys manually; is very error-prone. The copy button on the right side of each key will
make copy/pasting easier.",'deepi'); ?></p>
<p><?php _e("Once you have filled in the required keys on the WordPress settings form, click on the Save Changes button at the bottom of the
form.",'deepi'); ?></p>
<p><?php _e("If you have correctly provided WordPress with your Deepi keys, you will see a success message.",'deepi'); ?></p>
</li>
<li><p><?php _e("If your Deepi account credit is positive, the WordPress setting page status switches to &quot;active&quot;.",'deepi'); ?></p>
</li>
<li><p><?php _e("Click on the &quot;Index&quot; button to send your content to Deepi servers. After that, everything will be kept in sync
